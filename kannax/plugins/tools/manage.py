...
async def status(message: Message) -> None:
    ...
    if not type_:
        out_str = f"""📊 **--KannaX Status--** 📊

🗃 **Plugins** : `{len(kannax.manager.plugins)}`
        ✅ **Loaded** : `{len(kannax.manager.loaded_plugins)}`
        ➕ **Enabled** : `{len(kannax.manager.enabled_plugins)}`
        ➖ **Disabled** : `{len(kannax.manager.disabled_plugins)}`
        ❎ **Unloaded** : `{len(kannax.manager.unloaded_plugins)}`

⚔ **Commands** : `{len(kannax.manager.commands)}`
        ✅ **Loaded** : `{len(kannax.manager.loaded_commands)}`
        ➕ **Enabled** : `{len(kannax.manager.enabled_commands)}`
        ➖ **Disabled** : `{len(kannax.manager.disabled_commands)}`
        ❎ **Unloaded** : `{len(kannax.manager.unloaded_commands)}`

⚖ **Filters** : `{len(kannax.manager.filters)}`
        ✅ **Loaded** : `{len(kannax.manager.loaded_filters)}`
        ➕ **Enabled** : `{len(kannax.manager.enabled_filters)}`
        ➖ **Disabled** : `{len(kannax.manager.disabled_filters)}`
        ❎ **Unloaded** : `{len(kannax.manager.unloaded_filters)}`
"""
    elif "p" in type_:
        if name_:
...
🗂 **Total** : `{len(kannax.manager.plugins)}`
✅ **Loaded** : `{len(kannax.manager.loaded_plugins)}`
➕ **Enabled** : `{len(kannax.manager.enabled_plugins)}`
➖ **Disabled** : `{len(kannax.manager.disabled_plugins)}`
...
🗂 **Total** : `{len(kannax.manager.commands)}`
✅ **Loaded** : `{len(kannax.manager.loaded_commands)}`
➕ **Enabled** : `{len(kannax.manager.enabled_commands)}`
➖ **Disabled** : `{len(kannax.manager.disabled_commands)}`
...
🗂 **Total** : `{len(kannax.manager.filters)}`
✅ **Loaded** : `{len(kannax.manager.loaded_filters)}`
➕ **Enabled** : `{len(kannax.manager.enabled_filters)}`
