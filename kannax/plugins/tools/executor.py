...
@kannax.on_cmd(
    ...
    about={
        ...
        "examples": [
            "{tr}eval print('KannaX')",
            "{tr}eval -s print('KannaX')",
            "{tr}eval 5 + 6",
            "{tr}eval -s 5 + 6",
        ],
    },
...
async def eval_(message: Message):
    ...
    async def aexec(code):
        head = "async def __aexec(kannax, message):\n "
        if "\n" in code:
        ...
        return await locals()["__aexec"](kannax, message)
