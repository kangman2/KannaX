...
@kannax.on_cmd("vdelto", about={"header": "View auto message delete timeout"})
...
@kannax.on_cmd("vapicto", about={"header": "View auto profile picture timeout"})
...
@kannax.on_cmd("vesto", about={"header": "View edit sleep timeout"})
