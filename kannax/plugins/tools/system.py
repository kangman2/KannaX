...
async def restart_(message: Message):
    """restart KannaX"""
    await message.edit("`Restarting KannaX Services`", log=__name__)
    LOG.info("KannaX Services - Restart initiated")
...
@kannax.on_cmd(
    "shutdown", about={"header": "shutdown KannaX :)"}, allow_channels=False
)
