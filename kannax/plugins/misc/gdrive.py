...
_LOG = kannax.getLogger(__name__)
...
class _GDrive:
    ...
    def _upload_file(self, file_path: str, parent_id: str) -> str:
        ...
        body = {
            "name": file_name,
            "mimeType": mime_type,
            "description": "Uploaded using KannaX",
        }
        if parent_id:
...
@kannax.on_cmd("gclear", about={"header": "Clear GDrive Creds"})
...
@kannax.on_cmd("greset", about={"header": "Reset parent id"})
...
@kannax.on_cmd("gempty", about={"header": "Empty the Trash"})
