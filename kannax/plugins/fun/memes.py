...
@kannax.on_cmd("Oof$", about={"header": "Ooooof"}, trigger="", allow_via_bot=False)
...
@kannax.on_cmd("clock$", about={"header": "kensar clock animation"})
...
@kannax.on_cmd("emoji$", about={"header": "Multiple Animated Emojis"})
...
@kannax.on_cmd("bigoof$", about={"header": "Use when something is beyond just oof"})
...
@kannax.on_cmd("earth$", about={"header": "Beautiful Earth Animation"})
...
@kannax.on_cmd("brain$", about={"header": "Dump your Brain into Trash"})
...
INSULT_STRINGS = (
    ...
    "Have you tried shooting yourself as high as 100m using a ckannax.",
