...
@kannax.on_cmd(
    ...
    about={
        ...
        "usage": "basta responder a qualquer mensagem do usuário ou adicionar user_id ou nome de usuário",
...
async def who_is(message: Message):
    ...
    if user_id:
        try:
            ...
            await message.err(
                "nenhum user_id ou mensagem válida especificada, faça .help whois para mais informações"
            )
            return
    ...
    if from_user or from_chat is not None:
        ...
        message_out_str += f"<b>🗣 Ultimo Namo:</b> <code>{from_user.last_name}</code>\n"
