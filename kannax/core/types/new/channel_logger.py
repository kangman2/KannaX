...
from kannax.utils import SafeDict, get_file_id, parse_buttons, rand_array
...
class ChannelLogger:
    """ Channel logger for KannaX """
    def __init__(self, client: Union['_client.KannaX', '_client.KannaXBot'], name: str) -> None:
    ...
    async def forward_stored(self,
                             client: Union['_client.KannaX', '_client.KannaXBot'],
                             message_id: int,
                             chat_id: int,
                             user_id: int,
        ...
        Parameters:
            client (`KannaX` | `KannaXBot`):
                Pass KannaX or KannaXBot.
