...
class Filter:
    ...
    @classmethod
    def parse(cls, **kwargs: Union[RawFilter, '_client.KannaX', int, bool]) -> 'Filter':
        """ parse filter """
    ...
    def _parse(allow_private: bool,
               ...
               allow_groups: bool,
               allow_channels: bool,
               **kwargs: Union[RawFilter, '_client.KannaX', int, bool]
               ) -> Dict[str, Union[RawFilter, '_client.KannaX', int, bool]]:
