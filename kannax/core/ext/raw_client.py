...
class RawClient(Client):
    ...
    def __init__(self, bot: Optional['kannax.core.client.KannaXBot'] = None, **kwargs) -> None:
        self._bot = bot
        super().__init__(**kwargs)
        self._channel = kannax.core.types.new.ChannelLogger(self, "CORE")
        kannax.core.types.new.Conversation.init(self)
